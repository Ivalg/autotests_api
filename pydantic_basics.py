...
# )
# print("Course model:", course_default_model)
#
...
# class CourseSchemaDefault(BaseModel):
#     id: str = "course-id"
...
#
#
# course = CourseSchemaDefault()
# print("Course default values:", course)
#
#
# # default_factory для динамических значений
# class CourseSchemaDefault(BaseModel):
...
#
#
# course1 = CourseSchemaDefault()
# course2 = CourseSchemaDefault()
# print(course1.id)
# print(course2.id)
#
#
...
#
# # Инициализируем модель CourseSchema через передачу аргументов
# course_default_model = CourseSchema2(
#     id="course-id",
#     title="Playwright",
#     maxScore=100,
#     minScore=10,
...
#     }
# }
# course_dict_model = CourseSchema2(**course_dict)
# print('Course DICT model:', course_dict_model)
#
# # Инициализируем модель CourseSchema через JSON
# course_json = """
...
# }
# """
# course_json_model = CourseSchema2.model_validate_json(course_json)
# print('Course JSON model:', course_json_model)
